...
const Projects = () => {
  return (
    <div className="pt-[3rem] mt-[4rem] lg:mx-2 sm:mx-auto xl:mx-auto sm:text-center container bg-white text-black rounded-[50px] shadow-lg shadow-slate-900" id="projects">
