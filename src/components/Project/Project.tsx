...
const Projects = () => {
  return (
    <div className="pt-[3rem] mt-[4rem] mx-3 sm:mx-auto xl:mx-auto 2xl:mx-3 sm:text-center bg-white text-black rounded-[50px] shadow-lg shadow-slate-900" id="projects">
