  ...
  return (
    <div className='min-h-[70vh] flex flex-col-reverse mx-3 lg:grid lg:grid-cols-2 bg-white items-center rounded-[50px] overflow-hidden mt-[100px] shadow-lg shadow-slate-900' id="about">
      <div className='p-16 flex flex-col justify-around h-full items-start'>
        ...
        <a href='https://drive.google.com/file/d/1svNV24Iv-XGdV3mrXkjx_P1aGlq0Lhvh/view?usp=drive_link' className='mt-[1rem] px-6 py-3 bg-violet-900 font-semibold text-white rounded-md hover:bg-violet-600 hover:text-violet-900 transition-all duration-300 ' target='blank' >Curriculum</a>
      </div>
      <Image src={Desarrollador} alt="compu" className='h-[80%] rounded-3xl pr-[1.5rem] object-cover' />
    </div>
  )
