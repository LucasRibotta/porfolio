...
export default function HomeSection() {
    return (
        <div className="flex flex-col min-h-screen box-border justify-center items-center text-gray-300" id="home">
            ...
            <div className="w-[70%] pt-20 flex flex-wrap items-center">
                ...
                <Image src={MongoDb} alt="Tailwind" title="mongodb" className="h-[65px] w-[65px] object-scale-down m-auto" />
                <Image src={NodeJs} alt="Tailwind" title="node" className="h-[65px] w-[65px] object-scale-down m-auto" />
            </div>
        </div>
    )
}
